...
enum power_supply_type {
	...
	POWER_SUPPLY_TYPE_TYPEC_PD,	/* TYPEC Port Power Delivery*/
	POWER_SUPPLY_TYPE_TYPEC_SINK,	/* TYPEC Port Sink*/
	POWER_SUPPLY_TYPE_TYPEC_SRC,	/* TYPEC Port Source*/
	POWER_SUPPLY_TYPE_TYPEC_DBG,	/* TYPEC Port Debug*/
	POWER_SUPPLY_TYPE_TYPEC_PWR,	/* TYPEC Port Powered*/
	POWER_SUPPLY_TYPE_TYPEC_AUDIO,	/* TYPEC Port Audio*/
	POWER_SUPPLY_TYPE_TYPEC_UNSUPP,	/* TYPEC Port Unsupported*/
};
